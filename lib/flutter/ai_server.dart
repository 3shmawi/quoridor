...
class AIService {
  ...
  static const String _apiUrl =
      'https://us-central1-dreamflow-prod.cloudfunctions.net/dreamflowOpenaiProxyHttpsFn';

  // Main method expected by game page
  static Future<GameMove?> getMove(
    GameState gameState,
    AIDifficulty difficulty,
  ) {
    return generateMove(gameState, difficulty);
  }
